...
* Outcome: AMR Global Burden (Treated)
...
use "treatment_amrgbdAT_control.dta", clear
rename amr Y
...
, stub_lag(L#event) stub_lead(F#event) ///
  ...
  graph_opt(  ///
      title("AMR Global Burden (Treated): Event-Study Estimates (±5 Years)") ///
...
graph export amrgbdAT_did_pm5.svg
