...
# Ensure non-ASCII paths work reliably in CLI runs
invisible(suppressWarnings(try(Sys.setlocale("LC_CTYPE", "en_US.UTF-8"), silent = TRUE)))

# Read basemap (GS 2021 648)
basemap_file <- "../data/worldmap_gs_2021_648/Worldmap_GS_2021_648.shp"
my_sf <- read_sf(basemap_file)

# Read boundaries (overlay)
boundaries_file <- "../data/worldmap_gs_2021_648/Worldmap_GS_2021_648_boundaries.shp"
