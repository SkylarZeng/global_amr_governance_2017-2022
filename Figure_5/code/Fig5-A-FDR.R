...
# family of governance predictors. This variant uses the Fig5A early-adopter
# governance dataset and writes publication-style CSV outputs to `output/`.
# Usage: adjust `data_file` if needed and run with `Rscript code/Fig5-A-FDR.R`.
"""
...
data_file <- "data/fig5A_early_adopting_governance.csv"   # required CSV for Fig5A
output_prefix <- "output/Fig5A"
...
# Ensure output directory exists and write outputs
