# ============================================================================
# Fig5A-covid-forest.R
# ============================================================================
# Purpose: Generate forest plot for Figure 5A COVID-19 sensitivity analysis
# 
# Input:  output/Fig5A-fixed_model_results-COVID01.csv
# Output: output/Fig5A-fixed_model_results-COVID01.pdf
# ============================================================================
...
# Configuration
# ============================================================================
input_file <- "output/Fig5A-fixed_model_results-COVID01.csv"
output_file <- "output/Fig5A-fixed_model_results-COVID01.pdf"
