...
* AMU analysis
use "../data/treatment_AMU.dta", clear
rename AMU Y
...
, stub_lag(L#event) stub_lead(F#event) ///
  ...
  graph_opt(  ///
      title("AMU score event‐study estimates") ///
...
graph save "../output/AMU_event_study_combined.gph", replace

* — Export as a high‑resolution PNG
graph export "../output/AMU_event_study_combined.png", width(1200) replace

* Export to SVG
graph export ../output/AMU_event_study_combined.svg
