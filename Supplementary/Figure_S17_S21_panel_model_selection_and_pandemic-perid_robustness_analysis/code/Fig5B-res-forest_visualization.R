...
# Fig5B-res-forest.R
# ============================================================================
# Purpose: Generate forest plot for Figure 5B respiratory disease sensitivity analysis
# 
# Input:  output/Fig5B-fixed_model_results-respiratory.csv
# Output: output/Fig5B-fixed_model_results-respiratory.pdf
# ============================================================================
...
# Configuration
# ============================================================================
input_file <- "output/Fig5B-fixed_model_results-respiratory.csv"
output_file <- "output/Fig5B-fixed_model_results-respiratory.pdf"
