...
* Specification: Excluding 2020-2021 (COVID Sensitivity Test)
...
, stub_lag(L#event) stub_lead(F#event) ///
  ...
  graph_opt(  ///
      title("AMR Prevalence: Event-Study Estimates") ///
...
graph export amr_did_delete_covid.svg
