...
# Output: output/Fig5B-fixed_model_results-COVID01.csv
#         output/Fig5B-fixed_model_results-COVID01.pdf
# ============================================================================
...
output_dir <- "output"
output_prefix <- file.path(output_dir, "Fig5B-fixed_model_results-COVID01")
